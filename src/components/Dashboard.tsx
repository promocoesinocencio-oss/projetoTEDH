        ...
        <div className="bg-white/80 dark:bg-gray-800/50 backdrop-blur-md rounded-xl p-4 md:p-6 border border-purple-100 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-600">7.7/10</p>
            </div>
            <Heart className="w-8 h-8 text-blue-500" />
          </div>
          <p className="text-sm text-green-600 mt-2">↗️ +0.5 esta semana</p>
        </div>
        ...
        <div className="bg-white/80 dark:bg-gray-800/50 backdrop-blur-md rounded-xl p-4 md:p-6 border border-purple-100 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-purple-600">5 dias</p>
            </div>
            <TrendingUp className="w-8 h-8 text-purple-500" />
          </div>
          <p className="text-sm text-purple-600 mt-2">🔥 Continue assim!</p>
        </div>
